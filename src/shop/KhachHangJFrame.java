...
//        }
    try {
        Connection cons = DBConnect.getConnection();
        int value = Integer.parseInt(jtfMaKhachHang.getText());
        String sql = "Update KhachHang set  Name = ?,Address = ?,Phone = ?,Status = ? where Customer_id = ?";
        PreparedStatement ps = cons.prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS);
        ...
        ps.close();
        cons.close();
        JOptionPane.showMessageDialog(this, "Update khách hàng thành công!");
    } catch (SQLException ex) {
        Logger.getLogger(KhachHangJFrame.class.getName()).log(Level.SEVERE, null, ex);
    }
